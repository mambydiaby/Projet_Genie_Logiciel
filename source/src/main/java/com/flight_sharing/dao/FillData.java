...
public class FillData {
	...
	public static void addPilot() throws JsonProcessingException, Exception {
		...
		pilot[0] = new Pilot("Flower", "0", "ling", "JIARONG", "lingjiarong@gmail.com", "3 years",
	...
	public static void addAirplane() throws JsonProcessingException, Exception {
		...
		airplane[0] = new Airplane("Airbus_A220",
		...
		airplane[1] = new Airplane("Airbus_A330",
		...
		airplane[3] = new Airplane("Airbus_city",
